...
export default function SalesSummary({ sale }: { sale: Sale }) {

    return (
        <>
            <div className='mb-6  text-sm font-medium text-gray-500 border border-gray-200'>
                <p className='text-sm font-black text-gray-900 p-2 bg-gray-200 '>ID: {sale.id}</p>
                <ul
                    role="list"
                ...
                <dl className="space-y-6  text-sm font-medium text-gray-500 p-5">
                    ...
                    <div className="flex justify-between">
                        ...
                        <dd className="text-lg text-black font-black">{formatCurrency(sale.total)}</dd>
                    </div>
                </dl>
            </div>
        </>
